...
python3 WSeq2Seq.py --gpu=1 --epoch=80 --unit=256 --layer=3 \
...
-o="wdata/210" --save="save" --seed=0 --l2=0.000001 \
data5/issu.train \
data5/diff.train \
data5/msg.train \
data5/issu.vocab \
...
python3 WSeq2Seq.py --gpu=1 --epoch=80 --unit=512 --layer=2 \
-o="wdata/211" --save="save" --seed=1 --l2=0.000001 \
data5/issu.train \
data5/diff.train \
data5/msg.train \
data5/issu.vocab \
...
python3 WSeq2Seq.py --gpu=1 --epoch=80 --unit=512 --layer=2 \
-o="wdata/212" --save="save" --seed=2 --l2=0.000001 \
data5/issu.train \
data5/diff.train \
data5/msg.train \
data5/issu.vocab \
...
python3 WSeq2Seq.py --gpu=1 --epoch=80 --unit=512 --layer=2 \
-o="wdata/213" --save="save" --seed=3 --l2=0.000001 \
data5/issu.train \
data5/diff.train \
data5/msg.train \
data5/issu.vocab \
...
python3 WSeq2Seq.py --gpu=1 --epoch=80 --unit=512 --layer=2 \
-o="wdata/214" --save="save" --seed=4 --l2=0.000001 \
data5/issu.train \
data5/diff.train \
data5/msg.train \
data5/issu.vocab \
